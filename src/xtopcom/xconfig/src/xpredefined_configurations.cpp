...
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(register_advance_whitelist);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(register_validator_whitelist);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(register_exchange_whitelist);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(register_edge_whitelist);
XDEFINE_ONCHAIN_GOVERNANCE_PARAMETER(register_archive_whitelist);
