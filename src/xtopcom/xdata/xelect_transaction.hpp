...
#define XADD_ONCHAIN_GOVERNANCE_PARAMETER2(NAME, VALUE) m_initial_values.insert({top::config::x##NAME##_onchain_goverance_parameter_t::name, (VALUE)})
        ...
        XADD_ONCHAIN_GOVERNANCE_PARAMETER(register_advance_whitelist);
        XADD_ONCHAIN_GOVERNANCE_PARAMETER(register_validator_whitelist);
        XADD_ONCHAIN_GOVERNANCE_PARAMETER(register_exchange_whitelist);
        XADD_ONCHAIN_GOVERNANCE_PARAMETER(register_edge_whitelist);
        XADD_ONCHAIN_GOVERNANCE_PARAMETER(register_archive_whitelist);
