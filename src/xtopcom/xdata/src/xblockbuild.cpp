...
xrelayblock_build_t::xrelayblock_build_t(base::xvblock_t* curr_block, const std::string & relay_block_data, const std::string & relay_wrap_data,
    ...
    base::xbbuild_para_t build_para(xrootblock_t::get_rootblock_chainid(), std::string(sys_contract_relay_table_block_addr1), block_height, //curr_block->get_height()/3,
...
xrelayblock_build_t::xrelayblock_build_t(const std::string & relay_block_data) {
    base::enum_xvblock_type _type = get_block_type_from_empty_block(std::string(sys_contract_relay_table_block_addr1));
    std::string hash(1, 0);

    base::xbbuild_para_t build_para(xrootblock_t::get_rootblock_chainid(), std::string(sys_contract_relay_table_block_addr1), 0,
        base::enum_xvblock_class_nil, base::enum_xvblock_level_table, _type, hash, hash);//xrootblock_t::get_rootblock_hash());
